                ...
                types: [
                    {
                        ...
                        handler: (entity) => {
                            ...
                            if (entity.team == TEAM_ELITES) return;
                    ...
                    /*{ // Work in progress (dread portal)
                        ...
                        handler: (entity) => {
                            ...
                            entity.team = TEAM_DREADNOUGHTS + entity.skill.score; // This is the function that makes dread teams random
                        ...
                        type: "pinkPortalOfficialV1",
                        destination: this.forgeBounds,
                        buffer: 5000,
                        spawnArray: validPositions,
                        handler: (entity) => {
                          if (entity.team == TEAM_ELITES) {                            
                            entity.destroyAllChildren();
                          } else {
                            entity.destroyAllChildren();
                            entity.reset(); // Remove non-player controllers
                            ...
                            entity.destroyAllChildren();
                            entity.upgrades = [];
                            entity.define('dreadOfficialV2');
                            entity.team = TEAM_ELITES;
                        };
                        },
                        entryBarrier: (entity) => {
                            return entity.skill.level >= 100;
                        }
                    }
                ]
            },
                ...
                types: [
                    {
                        ...
                        buffer: 50,
                        handler: (entity) => {
                            // Destroy the children upon travelling.
                         		entity.destroyAllChildren();
                        },
                        destinationArray: validPositions,
                        entryBarrier: (entity) => {
                            return entity.skill.level >= 40;
                        }
                    }
                ]
            },
        ...
        for (let batch of this.spawnBatches) {
            for (let portal of batch.types) {
                ...
                entity.on('death', ({body}) => {
                    ...
                    // Spawn after 80 seconds if a portal dies
