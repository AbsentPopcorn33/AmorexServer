...
// Bases
    ...
    trap: { reload: 23, shudder: 0.25, size: 0.6, damage: 0.7, speed: 5, spray: 15, resist: 3 },
...
// Spammers
    ...
    tripleShot: { reload: 1.15, recoil: 0.5, shudder: 0.8, health: 0.8, damage: 0.9, pen: 0.8, density: 0.8, spray: 0.5 },
    ...
    triplet: { reload: 1.3, recoil: 2/3, shudder: 0.9, health: 0.825, damage: 0.825, pen: 0.8, density: 1.1, spray: 0.9, resist: 0.95 },
...
// Snipers
    ...
    assassin: { reload: 1.6, shudder: 0.25, health: 1.15, pen: 2, speed: 1.18, maxSpeed: 1.18, density: 3, resist: 1.3 },
...
// Machine guns
    ...
    minigun: { reload: 1.25, recoil: 0.95, size: 0.8, health: 0.55, damage: 0.45, pen: 1.25, speed: 1.25, density: 1.25, spray: 0.5, resist: 1.1, range: 0.9},
    streamliner: { reload: 1.1,  recoil: 1, damage: 0.833, speed: 1.2, range: 0.85, density: 2, },
...
// Flanks
    ...
    triAngle: { recoil: 0.775, health: 0.8, speed: 0.8, maxSpeed: 0.8, range: 0.6 },
    triAngleFront: { recoil: 0.3, speed: 1.3, maxSpeed: 1.1, range: 1.5 },
    thruster: { recoil: 1.45, shudder: 2, health: 0.5, damage: 0.5, pen: 0.7, spray: 0.5, resist: 0.7 },
...
// Drones
    ...
    baseProtector: { reload: 6, recoil: 0.0000001, health: 100, range: 0.5, density: 500, resist: 10 },
...
// Heavy cannons
    pounder: { reload: 1.9, recoil: 1.6, damage: 2, speed: 0.85, maxSpeed: 0.8, density: 1.5, resist: 1.15 },
    destroyer: { reload: 2, recoil: 1.6, shudder: 0.5, health: 1.5, damage: 2, pen: 1.2, speed: 0.8, maxSpeed: 0.7, density: 2, resist: 1.5 },
    annihilator: { reload: 1.1, recoil: 1.25 },
    obliterator: { reload: 1.3, recoil: 1.225, health: 1.2, damage: 1.2, pen: 1.2, speed: 0.95, maxSpeed: 0.95, density: 1.5, resist: 0.9 },
    exterminator: { reload: 1.3, recoil: 1.25, shudder: 1, size: 1, health: 1.2, damage: 1.2, pen: 1.2, speed: 0.95, maxSpeed: 0.95, range: 1, density: 1.5, spray: 1, resist: 1.2 },
    liquidator: { reload: 1.25, recoil: 1.2, shudder: 1, size: 1, health: 1.2, damage: 1.2, pen: 1.2, speed: 0.975, maxSpeed: 0.975, range: 1, density: 1.5, spray: 1, resist: 1.2 },
...
// Missiles
    ...
    baseMissiler: { reload: 1.5, recoil: 0.8, shudder: 1.25, size: 0.95, health: 0.9, damage: 0.9, pen: 1.25, speed: 0.25, maxSpeed: 3, range: 0.6333, density: 0.8, spray: 1.1, resist: 1.1 },
  
// Traps and blocks
    megaTrap: { reload: 1.15, recoil: 1.5, shudder: 0.9, size: 1.1, health: 1.4, damage: 1.2, pen: 1.5, speed: 0.95, maxSpeed: 0.95, range: 0.95, density: 1.25, spray: 1, resist: 1.2 },
    gigaTrap: { reload: 1.2, recoil: 1.5, shudder: 0.95, size: 1.075, health: 1.25, damage: 1.05, pen: 1.2, speed: 0.925, maxSpeed: 0.925, range: 1, density: 1.2, spray: 1, resist: 1.1 },
    teraTrap: { reload: 1.3, recoil: 1.75, shudder: 0.975, size: 1.025, health: 1.3, damage: 0.95, pen: 1.3, speed: 1, maxSpeed: 1, range: 1, density: 1.2, spray: 1, resist: 1.1 },
    petaTrap: { reload: 1.3, recoil: 2, shudder: 1, size: 1, health: 1.2, damage: 1, pen: 1.2, speed: 1, maxSpeed: 1, range: 1, density: 1.5, spray: 1, resist: 1.1 },
    exaTrap: { reload: 1.3, recoil: 1.5, shudder: 0.9, size: 1, health: 1.2, damage: 1, pen: 1.2, speed: 1, maxSpeed: 1, range: 0.95, density: 1.3, spray: 1, resist: 1.05 },
    zettaTrap: { reload: 1.25, recoil: 1.4, shudder: 1, size: 1, health: 1.2, damage: 1.1, pen: 1.2, speed: 0.9, maxSpeed: 0.9, range: 0.9, density: 1.5, spray: 1, resist: 1.15 },
...
// Misc
    ...
    bpw: { reload: 2.5, recoil: 1e-7, shudder: 1, size: 1, health: 1, damage: 3, pen: 6, speed: 1.5, maxSpeed: 1.5, range: 1.25, density: 1000, spray: 1, resist: 5 },
