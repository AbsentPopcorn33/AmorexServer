...
Class.doubleTwin = {
    ...
    GUNS: weaponArray([
        ...
        {
            POSITION: [18, 7.75, 1, 0, -5.5, 0, 0.5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.doubleTwin]),
                TYPE: "bullet"
            }
...
Class.tripleTwin = {
    ...
    GUNS: weaponArray([
        ...
        {
            POSITION: [19, 7.75, 1, 0, -5.5, 0, 0.5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.spam, g.doubleTwin]),
                TYPE: "bullet"
            }
...
Class.hewnDouble = {
    ...
    GUNS: [
        {
            POSITION: [19, 7.75, 1, 0, 5.5, 205, 0.5],
            PROPERTIES: {
        ...
        {
            POSITION: [19, 7.75, 1, 0, -5.5, -205, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.twin, g.doubleTwin, g.hewnDouble, { recoil: 1.15 }]),
                TYPE: "bullet"
            }
        ...
        {
            POSITION: [20, 7.75, 1, 0, 5.5, 180, 0],
            PROPERTIES: {
        ...
        {
            POSITION: [20, 7.75, 1, 0, -5.5, 180, 0.5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.doubleTwin, g.hewnDouble, { recoil: 1.15 }]),
                TYPE: "bullet"
            }
        ...
        {
            POSITION: [20, 7.75, 1, 0, -5.5, 0, 0.5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.doubleTwin, g.hewnDouble]),
                TYPE: "bullet"
            }
...
Class.heptaShot = {
    ...
    GUNS: [
        {
            POSITION: [15.1, 7.75, 1, 0, 3.9,  45, 3/4],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.tripleShot]),
                TYPE: "bullet"
            }
  ...
  Class.nonaShot = {
    ...
    DANGER: 9,
    BODY: {
        SPEED: 0.87 * base.SPEED
    },
    GUNS: [
        {
            POSITION: [13.5, 7.75, 1, 0, 4.8,  58, 4/5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.tripleShot]),
                TYPE: "bullet"
            }
            ...
            POSITION: [15.1, 7.75, 1, 0, 3.9,  45, 3/5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.tripleShot]),
                TYPE: "bullet"
            }
  ...
  Class.unfurler = {
    ...
    DANGER: 10,
    BODY: {
        SPEED: 0.84 * base.SPEED
    },
    GUNS: [
        {
            POSITION: [12.1, 7.75, 1, 0, 5.7,  72, 5/6],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.tripleShot]),
                TYPE: "bullet"
            }
            ...
            POSITION: [13.5, 7.75, 1, 0, 4.8,  58, 4/6],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.tripleShot]),
                TYPE: "bullet"
            }
            ...
            POSITION: [15.1, 7.75, 1, 0, 3.9,  45, 3/6],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.tripleShot]),
                TYPE: "bullet"
            }
...
Class.bentDouble = {
    ...
    GUNS: weaponArray([
        {
            POSITION: [19, 7.75, 1, 0, -2, -17.5, 0.5],
            PROPERTIES: {
...
Class.quadruplet = {
    ...
    BODY: {
        FOV: 1 * base.FOV,
        SPEED: 0.93 * base.SPEED
    },
    GUNS: [ 
                   { /*** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
                    POSITION: [  16,    9.5,      1,      0,     -5,      0,    0.667, ], 
                        PROPERTIES: {
                            SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet]),
                            TYPE: 'bullet',
                        }, }, { 
...
Class.quintuplet = {
    ...
    BODY: {
        FOV: 0.97 * base.FOV,
        SPEED: 0.897 * base.SPEED
    },
    GUNS: [ 
                   { /*** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
                    POSITION: [  16,    9.5,      1,      0,     -5,      0,    0.2, ], 
                        PROPERTIES: {
                            SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet]),
                            TYPE: 'bullet',
                        }, }, { 
                    POSITION: [  16,    9.5,      1,      0,      5,      0,    0.4, ], 
                        PROPERTIES: {
                            SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet]),
                            TYPE: 'bullet',
                        }, }, { 
                    POSITION: [  19,    7,      1,      0,     -4,      0,    0.6, ], 
                        PROPERTIES: {
                            SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet]),
                            TYPE: 'bullet',
                        }, },  { 
                    POSITION: [  19,    7,      1,      0,      4,      0,    0.8, ], 
                        PROPERTIES: {
                            SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet]),
                            TYPE: 'bullet',
                        }, },  { 
...
Class.hextuplet = {
    ...
    BODY: {
        FOV: 0.98 * base.FOV,
        SPEED: 0.89 * base.SPEED
    },
    GUNS: [ 
                   { /*** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
                    POSITION: [  16,    9.5,      1,      0,     -5.2,      0,    1/6, ], 
                        PROPERTIES: {
                            SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet]),
                            TYPE: 'bullet',
                        }, }, { 
                    POSITION: [  16,    9.5,      1,      0,      5.2,      0,    1/6*2, ], 
                        PROPERTIES: {
                            SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet]),
                            TYPE: 'bullet',
                        }, }, { 
                    POSITION: [  19,    7,      1,      0,     -4.8,      0,    1/6*3, ], 
                        PROPERTIES: {
                            SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet]),
                            TYPE: 'bullet',
                        }, },  { 
                    POSITION: [  19,    7,      1,      0,      4.8,      0,    1/6*4, ], 
                        PROPERTIES: {
                            SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet]),
                            TYPE: 'bullet',
                        }, },  { 
                    POSITION: [  22,    6.66,      1,      0,      3.4,      0,    1/6*5, ], 
                        PROPERTIES: {
                            SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet]),
                            TYPE: 'bullet',
                        }, },  {
                    POSITION: [  22,    6.66,      1,      0,      -3.4,      0,    0, ], 
                        PROPERTIES: {
                            SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet]),
                            TYPE: 'bullet',
                        }, }, 
...
Class.assassin = {
    ...
    GUNS: [
        {
            POSITION: [27, 7.75, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assassin]),
                TYPE: "bullet"
            }
        },
      //  { // save it for higher tiers
...
Class.hunter = {
   ...
   // CONTROLLERS: ["zoom"], // We don't want this
  //  TOOLTIP: "Hold right click to zoom.",
    GUNS: [
        {
            POSITION: [24, 7.75, 1, 0, 0, 0, 0],
            PROPERTIES: {
        ...
        {
            POSITION: [21, 11.75, 1, 0, 0, 0, 0.25],
            PROPERTIES: {
...
Class.watchman = {
    ...
    DANGER: 8,
    BODY: {
        SPEED: 0.78 * base.SPEED,
        FOV: 1.65 * base.FOV,
    },
    GUNS: [
        {
            POSITION: [36, 8.35, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assassin, {pen:1.4, range: 1.15}]),
                TYPE: "bullet",
            },
        },
        {
            POSITION: [5.25, 8.35, -1.6, 8, 0, 0, 0],
        },
    ],
}
Class.warden = {
    ...
    GUNS: [
        {
            POSITION: [40, 8.35, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assassin, {pen: 1.55, range: 1.3}]),
                TYPE: "bullet",
            },
        },
        {
            POSITION: [5.25, 8.35, -1.735, 8, 0, 0, 0],
        },
    ],
}
Class.telescope = {
    ...
    DANGER: 10,
    BODY: {
        SPEED: 0.735* base.SPEED,
        FOV: 1.88 * base.FOV,
    },
    GUNS: [
        {
            POSITION: [44, 8.35, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assassin, {pen: 1.75, range: 1.4}]),
                TYPE: "bullet",
            },
          
        },
     {
            POSITION: [20, 0.5, 1, 0, 0, 0, 0],
        },
        {
            POSITION: [5, 9.9, -1.735, 7.5, 0, 0, 0],
        },
    ],
}
Class.observatory = {
    ...
    DANGER: 11,
    BODY: {
        SPEED: 0.7175* base.SPEED,
        FOV: 2 * base.FOV,
    },
    GUNS: [
      { POSITION: [36, 9, -1.3, 0, 0, 0, 0],
           },   {
            POSITION: [47, 8, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assassin, {pen: 1.95, range: 1.55, resist: 1.4}]),
                TYPE: "bullet",
            },
          
        },
     
      { POSITION: [25, 0.5, 1, 0, 0, 0, 0],
           
 
            },{
            POSITION: [5, 9.75, -1.735, 7.5, 0, 0, 0],
        },
    ],
}
Class.stalker = {
...
Class.single = {
    ...
    GUNS: [
        ...
        {
            POSITION: [5.5, 7.75, -1.8, 6.5, 0, 0, 0]
        }
    ]
}
...
Class.predator = {
    ...
    GUNS: [
        ...
        {
            POSITION: [21, 11.75, 1, 0, 0, 0, 0.15],
            PROPERTIES: {
...
Class.streamliner = {
    ...
    BODY: {
        FOV: 1.25,
        SPEED: base.SPEED * 0.915
    },
    GUNS: [
        {
            POSITION: [23, 8, 1, 0, 0, 0, 0.75],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun,]),
                TYPE: "bullet",
            },
...
Class.showerer = {
    ...
    BODY: {
        FOV: 1.33,
        SPEED: base.SPEED * 0.8667
    },
    GUNS: [
        {
            POSITION: [25, 8, 1, 0, 0, 0, 0.8
                      ],
            PROPERTIES: {
  ...
  Class.fluctuator = {
    ...
    GUNS: [
        ...
        {
            POSITION: [24, 8, 1, 0, 0, 0, 1/6*3],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
        },{
            POSITION: [22, 8, 1, 0, 0, 0, 1/6*2],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
  ...
  Class.rationalizer = {
    ...
    GUNS: [
        ...
        {
            POSITION: [25, 8, 1, 0, 0, 0, 1/7*4],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [23, 8, 1, 0, 0, 0, 1/7*3],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [21, 8, 1, 0, 0, 0, 1/7*2],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [19, 8, 1, 0, 0, 0, 1/7*1],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
  ...
  Class.superfluous = {
    ...
    BODY: {
        FOV: 1.5675,
        SPEED: base.SPEED * 0.755
    },
    GUNS: [
        {
            POSITION: [30.75, 8, 1, 0, 0, 0, 1/8*7],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
        ...
        {
            POSITION: [28.75, 8, 1, 0, 0, 0, 1/8*6],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
        ...
        {
            POSITION: [26.75, 8, 1, 0, 0, 0, 1/8*5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [24.75, 8, 1, 0, 0, 0, 1/8*4],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [22.75, 8, 1, 0, 0, 0, 1/8*3],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [20.75, 8, 1, 0, 0, 0, 1/8*2],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [18.75, 8, 1, 0, 0, 0, 1/8*1],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [16.75, 8, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.streamliner]),
                TYPE: "bullet",
            },
...
Class.dodecaTank = {
    ...
    GUNS: weaponArray([
        ...
        {
            POSITION: [18, 8, 1, 0, 0, 360/12, 0.5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.flankGuard, g.spam]),
                TYPE: "bullet"
            }
...
Class.obliterator = {
    ...
    GUNS: [
        {
            POSITION: [20.5, 16, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.destroyer, g.annihilator, g.obliterator]),
                TYPE: "bullet",
            },
        },
    ],
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.destroyer, g.annihilator, g.obliterator, g.exterminator]),
                TYPE: "bullet",
            },
        },
    ],},
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.destroyer, g.annihilator, g.obliterator, g.exterminator, g.liquidator]),
                TYPE: "bullet",
            },
        },
    ],},
Class.decimator = {
    ...
    GUNS: [
        {
            POSITION: [20.5, 19.8, 1.2, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.destroyer, g.annihilator, g.obliterator, g.exterminator, g.liquidator, g.liquidator]),
                TYPE: "bullet",
            },
        },
    ],},
...
Class.skimmer = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.artillery, g.artillery, g.skimmer, g.baseMissiler]),
                TYPE: "missile",
                STAT_CALCULATOR: "sustained",
            },
        },
...
Class.twister = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.artillery, g.artillery, g.skimmer, g.baseMissiler, { reload: 4/3 }]),
                TYPE: "spinmissile",
                STAT_CALCULATOR: "sustained",
            },
        },
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.launcher, g.rocketeer, g.baseMissiler]),
...
Class.propeller = {
    ...
    GUNS: [
        ...
        },
        {
            POSITION: [17, 15, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.artillery, g.artillery, g.baseMissiler]),
                TYPE: "triAngleMissile",
                STAT_CALCULATOR: "sustained",
            },
        },
    ],
...
Class.megaTrapper = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.megaTrap, g.gigaTrap]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap"
            }
        }
...
Class.gigaTrapper = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.megaTrap, g.gigaTrap, g.teraTrap]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap"
            }
        }
...
Class.ultraTrapper = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.megaTrap, g.gigaTrap, g.teraTrap, g.petaTrap]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap"
            }
        }
...
Class.alphaTrapper = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.megaTrap, g.gigaTrap, g.teraTrap, g.petaTrap, g.exaTrap]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap"
            }
        }
...
Class.gammaTrapper = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.megaTrap, g.gigaTrap, g.teraTrap, g.petaTrap, g.exaTrap, g.zettaTrap]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap"
            }
        }
...
Class.omegaTrapper = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.megaTrap, g.gigaTrap, g.teraTrap, g.petaTrap, g.exaTrap, g.zettaTrap, g.exaTrap]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap"
            }
        }
...
Class.extender = makeOver('unfurler', 'Extender',{count: 1, independent: true, cycle: false})
Class.centurion = makeOver('hextuplet', 'Centurion',{count: 1, independent: true, cycle: false})
Class.wave = makeOver('rationalizer', 'Wave',{count: 1, independent: true, cycle: false})
...
// Upgrade Paths
Class.basic.UPGRADES_TIER_1 = ["twin", "sniper", "machineGun", "flankGuard", "pounder", "trapper"]
  //  Class.basic.UPGRADES_TIER_2 = ["smasher"]
    ...
    Class.twin.UPGRADES_TIER_2 = ["tripleShot", /*"gunner",*/ "quadTank"]
    //  Class.twin.UPGRADES_TIER_3 = ["dual", "bulwark", "musket"]
        ...
        Class.pentaShot.UPGRADES_TIER_4 = ["heptaShot"]
        Class.heptaShot.UPGRADES_TIER_5 = ["nonaShot"]
        Class.nonaShot.UPGRADES_TIER_6 = ["unfurler"]
        Class.unfurler.UPGRADES_TIER_8 = ["extender"]
        Class.triplet.UPGRADES_TIER_4 = ["quadruplet"],
        Class.quadruplet.UPGRADES_TIER_5 = ["quintuplet"]
        Class.quintuplet.UPGRADES_TIER_6 = ["hextuplet"]       
        Class.hextuplet.UPGRADES_TIER_8 = ["centurion"]
    ...
    Class.sniper.UPGRADES_TIER_2 = ["assassin",/* "hunter"*/ "minigun", /*"rifle",*/]
       // Class.sniper.UPGRADES_TIER_3 = ["bushwhacker"]
        ...
        Class.ranger.UPGRADES_TIER_4 = ['watchman']
        Class.watchman.UPGRADES_TIER_5 = ['warden']
        Class.warden.UPGRADES_TIER_6 = ['telescope']
        Class.telescope.UPGRADES_TIER_7 = ['observatory']
    ...
    Class.machineGun.UPGRADES_TIER_2 = [/*"artillery",*/ "minigun", /*"gunner", "sprayer"*/]
        ...
        Class.streamliner.UPGRADES_TIER_4 = ["showerer"],
        Class.showerer.UPGRADES_TIER_5 = ["fluctuator"],
        Class.fluctuator.UPGRADES_TIER_6 = ["rationalizer"],
        Class.rationalizer.UPGRADES_TIER_8 =["superfluous", "wave"]


    Class.flankGuard.UPGRADES_TIER_2 = ["triAngle", /*"auto3", "trapGuard", "triTrapper"*/]
        Class.flankGuard.UPGRADES_TIER_3 = ["quadTank",/* "tripleTwin", "quadruplex"*/]
        Class.quadTank.UPGRADES_TIER_4 = ["hexaTank"]
        Class.triAngle.UPGRADES_TIER_3 = [/*"fighter", "booster", "falcon", "bomber", "autoTriAngle", "surfer", "eagle", "phoenix", "vulture",*/ "quadTank"]
        Class.auto3.UPGRADES_TIER_3 = ["auto5", "mega3", "auto4", "banshee"]
        Class.hexaTank.UPGRADES_TIER_5 = ["octoTank", /*"hexaTrapper"*/]
        Class.octoTank.UPGRADES_TIER_6 = ["decaTank"]
        Class.decaTank.UPGRADES_TIER_8 = ["dodecaTank"]
    ...
    Class.pounder.UPGRADES_TIER_2 = ["destroyer", /*"artillery", "launcher"*/]
        ...
        Class.annihilator.UPGRADES_TIER_4 = ["obliterator"]
        Class.obliterator.UPGRADES_TIER_5 = ["exterminator"]
        Class.exterminator.UPGRADES_TIER_6 = ["liquidator"]
        Class.liquidator.UPGRADES_TIER_8 = ["decimator"]


    Class.trapper.UPGRADES_TIER_2 = ["tricker"/*,"triTrapper"*/],
       // Class.trapper.UPGRADES_TIER_3 = ["barricade"],
        Class.tricker.UPGRADES_TIER_3 =["megaTrapper"],
        Class.builder.UPGRADES_TIER_3 = ["construct"],
        Class.triTrapper.UPGRADES_TIER_3 = ["hexaTrapper", "septaTrapper"]
        Class.trapGuard.UPGRADES_TIER_3 = ["bushwhacker", "gunnerTrapper", "bomber", "conqueror", "bulwark"]
        Class.megaTrapper.UPGRADES_TIER_4 = ["ultraTrapper"]
        Class.ultraTrapper.UPGRADES_TIER_5 = ["alphaTrapper"]
        Class.alphaTrapper.UPGRADES_TIER_6 = ["gammaTrapper"]
        Class.gammaTrapper.UPGRADES_TIER_8 = ["omegaTrapper"]
