 ...
 GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.bpw]),
                TYPE: "bullet",
            },
        },
        {
...
Class.baseWardenTurret = makeTurret({
    GUNS: [
        {
            POSITION: [36, 8.35, 1, 0, 0, 0, 0],
            PROPERTIES: {
...
}, {label: "Protector", independent: true, limitFov: true, aiSettings: {NO_LEAD: false, LIKES_SHAPES: false}})
