...
let generatorMatrix = [
    [ "egg"           , "gem"                , "jewel"                  , "crasher"             , "sentry"               , "shinySentry"        , "EggRelic"           , "notwzPentagon"],
    ...
    [ "betaPentagon"  , "shinyBetaPentagon"  , "legendaryBetaPentagon"  , "shadowBetaPentagon"  , "rainbowBetaPentagon"  , "transBetaPentagon"  , "HexagonRelic"       , "dodecahedron" ],
    [ "alphaPentagon" , "shinyAlphaPentagon" , "legendaryAlphaPentagon" , "shadowAlphaPentagon" , "rainbowAlphaPentagon" , "transAlphaPentagon" , "HeptagonRelic"      , "icosahedron"  ],
    [ "hexagon"       , "shinyHexagon"       , "legendaryHexagon"       , "shadowHexagon"       , "rainbowHexagon"       , "transHexagon"       , "BetaPentagonRelic"  , "tesseract",   ],
],
gemRelicMatrix = [];
...
Class.notwzShapeTest = {
    PARENT: 'genericTank',
    LABEL: "Image Shape Test",
   // SHAPE: 'https://cdn.glitch.global/da897f11-c99e-458d-8a99-2fb876c3add1/1723230179650.png?v=1723253023002',
    SHAPE: 'https://cdn.glitch.global/da897f11-c99e-458d-8a99-2fb876c3add1/IMG_8821.jpg?v=1723521971667',
  GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
            PROPERTIES: {
...
Class.trollTrapper1 = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.megaTrap, g.gigaTrap, g.teraTrap, g.petaTrap, g.exaTrap, g.zettaTrap, g.exaTrap, g.exaTrap]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap"
            }
        }
...
Class.whyTrapper = {
    PARENT: "genericTank",
    LABEL: "Why does this exist-Trapper",
    DANGER: 13,
    STAT_NAMES: statnames.trap,
    GUNS: [
        {
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.megaTrap, g.gigaTrap, g.teraTrap, g.petaTrap, g.exaTrap, g.zettaTrap, g.exaTrap, g.exaTrap, g.exaTrap]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap"
            }
        }
...
Class.normalTrapper = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.megaTrap, g.gigaTrap, g.teraTrap, g.petaTrap, g.exaTrap, g.zettaTrap, g.exaTrap, g.exaTrap, g.exaTrap, g.exaTrap]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap"
            }
        }
...
Class.developer.UPGRADES_TIER_0 = ["tanks", "bosses", "spectator", "levels", "teams", "eggGenerator", "testing", "addons", "betaTester"]
    Class.tanks.UPGRADES_TIER_0 = ["basic", "unavailable", "betaTanks", "arenaCloser", "dominators", "sanctuaries", "mothership", "baseProtector", "antiTankMachineGun"]
