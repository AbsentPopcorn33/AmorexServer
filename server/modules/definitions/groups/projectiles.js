...
Class.triAngleMissile = {
    PARENT: "missile",
    GUNS: [
        {
            POSITION: [17, 7, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.triAngle, g.triAngleFront, g.lowPower, {reload: 1.65, recoil: 1.75 }]),
                TYPE: "bullet",
        
                AUTOFIRE: true,        LABEL: "Front",
            },
        },
        {
            POSITION: [15.5, 6.75, 1, 0, 0, 150, 0.1],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.triAngle, g.thruster, g.lowPower, {reload: 1.65}]),
                TYPE: "bullet",
           
                AUTOFIRE: true,     LABEL: "thruster",
            },
        },
        {
            POSITION: [15.5, 6.75, 1, 0, 0, 210, 0.1],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.triAngle, g.thruster, g.lowPower, {reload: 1.65}]),
                TYPE: "bullet",
...
Class.setTrap = {
    ...
    SHAPE: -4,
    MOTION_TYPE: "motor",
    //CONTROLLERS: ["goToMasterTarget"], Nope
    BODY: {
        SPEED: 1,
        DENSITY: 5,
    },
