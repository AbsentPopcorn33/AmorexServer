let fs = require('fs'),
    ...
    wsServer;
let browserData = [
    ["amorex-ser-ft-aqocnoajxo.glitch.me", "DEV", true, views.length],
    ["amorex-ser-ft-asia.glitch.me", "ASIA", true, views.length],
    ["amorex-ser-ft-europe.glitch.me", "EUROPE", false, views.length],
    ["amorex-ser-ft-oceania.glitch.me", "", true, views.length]
];
...
server = require('http').createServer((req, res) => {
    ...
    if (req.url.startsWith('/shared/')) {
        ...
        case "/browserData.json":
            resStr = JSON.stringify(browserData); 
            break;
        default:
        break;
    }
